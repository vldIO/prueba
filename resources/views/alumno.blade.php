          ...
          <table class="table table-sm table-hover" style="text-align: center">
            ...
            @foreach($alumnos as $alumno)
              <tr>
                  ...
                  <td><a href="{!! route('alumnos.edit', $alumno->id) !!}"><span class="oi oi-pencil"></span> </a>
                  
                  <a href="{!! action('AlumnoController@destroy', $alumno->id) !!}" method="POST"> <span class="oi oi-trash"></span></a> </td>
              </tr>
              @endforeach
            </tbody>
          </table>
